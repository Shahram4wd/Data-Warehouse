"""
Django management command for syncing Genius MarketSharp marketing source maps.
Follows CRM sync guide patterns with proper SyncHistory integration, batch processing, and timezone handling.
"""
import logging
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if since:
                sync_params['since_date'] = since
            if start_date:
                sync_params['start_date'] = start_date
            
            # Execute sync
            stats = engine.sync_marketsharp_marketing_source_maps(**sync_params)
