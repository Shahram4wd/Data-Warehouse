"""
Management command to sync CallReil trackers data
"""
import logging
import asyncio
...
class Command(BaseCommand):
    help = 'Sync CallReil trackers data'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f'Starting CallReil trackers sync for account: {account_id}')
            )
            ...
            logger.error(f"CallReil trackers sync failed: {e}")
