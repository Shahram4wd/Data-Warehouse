"""
Django management command for syncing Genius users using the new sync engine architecture.
...
from ingestion.sync.genius.engines.users import GeniusUsersSyncEngine

logger = logging.getLogger(__name__)


class Command(BaseCommand):
    help = 'Sync Genius users data using the standardized sync engine'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            logger.exception("Genius users sync failed")
            self.stdout.write(
