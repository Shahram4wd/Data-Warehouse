"""
Django management command for syncing Genius services data.
...
class Command(BaseCommand):
    help = 'Sync Genius services data with delta updates and bulk operations'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            logger.exception("Services sync failed")
            self.stdout.write(
