"""
CallReil calls sync engine for orchestrating calls synchronization
"""
import logging
from typing import Dict, Any, List, Optional
from datetime import datetime
from .base import CallReilBaseSyncEngine
...
class CallsSyncEngine(CallReilBaseSyncEngine):
    """Sync engine for CallReil calls"""
    ...
    def get_last_sync_timestamp(self, account_id: str) -> Optional[datetime]:
        ...
        from ...models import CallReil_Call
        latest_call = (CallReil_Call.objects
