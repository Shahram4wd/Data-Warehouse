...
class GeniusMarketsharpSourcesSyncEngine(GeniusBaseSyncEngine):
    ...
    async def execute_sync(self, 
        ...
        return await self.sync_marketsharp_sources(
    ...
    async def sync_marketsharp_sources(self, since_date=None, force_overwrite=False, 
        ...
        try:
            ...
            logger.error(f"Error in sync_marketsharp_sources: {e}")
            stats['errors'] += 1
            raise
