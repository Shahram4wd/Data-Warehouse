"""
appointment services sync engine for Genius CRM
"""
import logging
...
class GeniusAppointmentServicesSyncEngine(GeniusBaseSyncEngine):
    """Sync engine for Genius appointment services data"""
    
    def __init__(self):
        super().__init__('appointment_services')
